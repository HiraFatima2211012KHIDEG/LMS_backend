...
class CourseListCreateAPIView(CustomResponseMixin, APIView):
    ...
    def get(self, request, format=None):
        ...
        return self.custom_response(
            status.HTTP_200_OK, "Courses retrieved successfully", serializer.data
        )
    ...
    def post(self, request, format=None):
        ...
        if serializer.is_valid():
            ...
            return self.custom_response(
                status.HTTP_201_CREATED, "Course created successfully", serializer.data
            )

        logger.error("Error creating a new course: %s", serializer.errors)
        return self.custom_response(
            status.HTTP_400_BAD_REQUEST, "Error creating course", serializer.errors
        )
...
class CourseDetailAPIView(CustomResponseMixin, APIView):
    ...
    def get(self, request, pk, format=None):
        ...
        return self.custom_response(
            status.HTTP_200_OK, "Course retrieved successfully", serializer.data
        )
    ...
    def put(self, request, pk, format=None):
        ...
        if serializer.is_valid():
            ...
            return self.custom_response(
                status.HTTP_200_OK, "Course updated successfully", serializer.data
            )

        logger.error(f"Error updating course with ID {pk}: {serializer.errors}")
        return self.custom_response(
            status.HTTP_400_BAD_REQUEST, "Error updating course", serializer.errors
        )
...
class ModuleListCreateAPIView(CustomResponseMixin, APIView):
    ...
    def post(self, request, format=None):
        ...
        if serializer.is_valid():
            ...
            return self.custom_response(
                status.HTTP_201_CREATED, "Module created successfully", serializer.data
            )

        return self.custom_response(
            status.HTTP_400_BAD_REQUEST, "Error creating Module", serializer.errors
        )
...
class ModuleDetailAPIView(CustomResponseMixin, APIView):
    ...
    def get(self, request, pk, format=None):
        ...
        return self.custom_response(
            status.HTTP_200_OK, "Module retrieved successfully", serializer.data
        )
    ...
    def put(self, request, pk, format=None):
        ...
        if serializer.is_valid():
            ...
            return self.custom_response(
                status.HTTP_200_OK, "Module updated successfully", serializer.data
            )

        return self.custom_response(
            status.HTTP_400_BAD_REQUEST, "Error updating module", serializer.errors
        )
    ...
    def delete(self, request, pk, format=None):
        ...
        module.delete()
        return self.custom_response(
            status.HTTP_204_NO_CONTENT, "Module deleted successfully", {}
        )
...
class ToggleActiveStatusAPIView(CustomResponseMixin, APIView):
    ...
    def patch(self, request, model_name, pk, format=None):
        if model_name not in self.MODEL_SERIALIZER_MAPPING:
            return self.custom_response(
                status.HTTP_400_BAD_REQUEST, "Invalid model name"
            )
        ...
        return self.custom_response(
            status.HTTP_200_OK, "Status toggled successfully", serializer.data
        )
